    ...
    <main class="welcome-card auth-welcome-card">
        ...
        <div class="welcome-card-content auth-welcome-content">
            <section class="auth-welcome-message">
                ...
                <p class="welcome-subtitle">Account recovery for the Administrator.</p>
                <p class="welcome-subtitle">Resetting password for <strong>{{ $maskedEmail }}</strong>.</p>
            </section>
            ...
            <section class="auth-shell-card auth-shell-card--welcome auth-shell-card--update">
                ...
                <form method="POST" action="{{ route('password.reset.submit.admin', ['id' => $reset->id]) }}">
                    @csrf
                    <label>New Password</label>
                    <div class="auth-password-wrap">
                        <input id="reset_password" class="auth-password-input" type="password" name="password" placeholder="Create a new password" autocomplete="new-password" required>
                        <button type="button" class="auth-password-toggle" data-toggle-password="reset_password" aria-label="Show password" aria-pressed="false">
                    ...
                    <div class="auth-password-wrap">
                        <input id="reset_password_confirmation" class="auth-password-input" type="password" name="password_confirmation" placeholder="Confirm new password" autocomplete="new-password" required>
                        <button type="button" class="auth-password-toggle" data-toggle-password="reset_password_confirmation" aria-label="Show password" aria-pressed="false">
                            <svg class="eye eye-open" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M2.5 12s3.6-6.2 9.5-6.2S21.5 12 21.5 12s-3.6 6.2-9.5 6.2S2.5 12 2.5 12z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                                <path d="M12 9v6"></path>
