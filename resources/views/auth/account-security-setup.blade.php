    ...
    <main class="welcome-card auth-welcome-card">
        ...
        <div class="welcome-card-content auth-welcome-content">
            <section class="auth-welcome-message">
                <p class="welcome-kicker">Account Security Setup</p>
                <h1>Secure your administrator account.</h1>
                <p class="welcome-subtitle">
                    Your account is using a temporary email address. Please set a valid email and a new password to continue.
                </p>
            </section>

            <section class="auth-shell-card auth-shell-card--welcome auth-shell-card--update">
                <div class="auth-shell-head">
                    <h2>Mandatory Setup</h2>
                    <p>Update your email and password before accessing the dashboard.</p>
                </div>
                ...
                <form method="POST" action="{{ route('account.security.setup.update') }}">
                    @csrf
                    ...
                    <input
                        ...
                        placeholder="Enter a valid email (e.g., your Gmail)"
                        autocomplete="email"
                        required
                    >
                    ...
                    <div class="auth-password-wrap">
                        <input id="setup_password" class="auth-password-input" type="password" name="password" placeholder="Create a new password" autocomplete="new-password" required>
                        <button type="button" class="auth-password-toggle" data-toggle-password="setup_password" aria-label="Show password" aria-pressed="false">
                    ...
                    <div class="auth-password-wrap">
                        <input id="setup_password_confirmation" class="auth-password-input" type="password" name="password_confirmation" placeholder="Confirm new password" autocomplete="new-password" required>
                        <button type="button" class="auth-password-toggle" data-toggle-password="setup_password_confirmation" aria-label="Show password" aria-pressed="false">
                            <svg class="eye eye-open" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M2.5 12s3.6-6.2 9.5-6.2S21.5 12 21.5 12s-3.6 6.2-9.5 6.2S2.5 12 2.5 12z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                                <path d="M12 9v6"></path>
                    ...
                    <button class="btn btn-auth mt-12" type="submit">Save and Continue</button>
                </form>

                <p class="auth-foot-link"><a href="{{ route('logout.get') }}">Sign out</a></p>
            </section>
        </div>
