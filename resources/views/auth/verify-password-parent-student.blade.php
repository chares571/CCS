    ...
    <main class="welcome-card auth-welcome-card">
        ...
        <div class="welcome-card-content auth-welcome-content">
            ...
            <section class="auth-shell-card auth-shell-card--welcome auth-shell-card--update">
                ...
                <form method="POST" action="{{ route('password.verify.submit.parent-student', ['id' => $reset->id]) }}">
                    @csrf
                ...
                <form method="POST" action="{{ route('password.resend.parent-student', ['id' => $reset->id]) }}" class="mt-12">
                    @csrf
